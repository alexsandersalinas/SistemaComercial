* rtp2.prg - Impressao ficha do tecnico
        ...
        USE dbRT SHARED
                REG1=RECCOUNT()
                 ...
                 SAVE SCRE TO INICIO
                        ...
                        SET COLOR TO W/B
                           @ 01,01 SAY "IMPRESS«O DA ORDEM DE SERVIÄO| FICHA DO TECNICO/MANUAL. "
                           varREG=(REG1)
                           @ 01,68 SAY varREG
                           @ 01,62 SAY "Registros:"
                           @ 23,02 SAY " F1  Ajuda"
...
SET COLOR TO (W/N,W/N)
   @ 02,00 CLEAR TO 24,79
   @ 02,00 SAY "OS Nß:"GET lNTNUM PICT "99999"
   READ
...
*// banco de dados DBnot1/2.dbf
      ...
      ENDIF
        ...
        LINHA=LINHA+1
          ...
          @ linha,pcol() say ltrim(ACESS)
          @ linha,pcol() say ltrim("Defeito:")
     ...
     linha=linha+2
         @ LINHA,02 SAY "CONSTATADOS: _____________________________________________________________"
         LINHA=LINHA+2
     @ linha,01 say "____________________________________________________________________________"
        linha=LINHA+1
        @ LINHA,02 SAY "PEÄAS APLICATAS" 
        linha=LINHA+1
        @ LINHA,02 SAY "DESCRIÄAO" 
        @ LINHA,30 SAY "QTDA"
        @ LINHA,38 SAY "VALOR UNITARIO"
        @ LINHA,57 SAY "TOTAL" 
        linha=LINHA+2
        @ LINHA,01 SAY "1: _________________________"
        @ LINHA,28 SAY "_____"
        @ LINHA,37 SAY "___________"
        @ LINHA,58 SAY "___________" 
        linha=LINHA+2
        @ LINHA,01 SAY "2: _________________________"
        @ LINHA,28 SAY "_____"
        @ LINHA,37 SAY "___________"
        @ LINHA,58 SAY "___________" 
        linha=LINHA+2
        @ LINHA,01 SAY "3: _________________________"
        @ LINHA,28 SAY "_____"
        @ LINHA,37 SAY "___________"
        @ LINHA,58 SAY "___________" 
        linha=LINHA+2
        @ LINHA,01 SAY "4: _________________________"
        @ LINHA,28 SAY "_____"
        @ LINHA,37 SAY "___________"
        @ LINHA,58 SAY "___________" 
        linha=LINHA+2
        @ LINHA,01 SAY "5: _________________________"
        @ LINHA,28 SAY "_____"
        @ LINHA,37 SAY "___________"
        @ LINHA,58 SAY "___________" 
        linha=LINHA+2
        @ LINHA,01 SAY "6: _________________________"
        @ LINHA,28 SAY "_____"
        @ LINHA,37 SAY "___________"
        @ LINHA,58 SAY "___________" 
        linha=LINHA+2
        @ LINHA,01 SAY "7: _________________________"
        @ LINHA,28 SAY "_____"
        @ LINHA,37 SAY "___________"
        @ LINHA,58 SAY "___________" 
        linha=LINHA+2
        @ LINHA,01 SAY "8: _________________________"
        @ LINHA,28 SAY "_____"
        @ LINHA,37 SAY "___________"
        @ LINHA,58 SAY "___________" 
        linha=LINHA+3
        @ LINHA,02 SAY "PECAS......:________________"
        LINHA=LINHA+2                                
        @ LINHA,02 SAY "MAO DE OBRA:________________"
        @ LINHA,40 SAY "TOTAL......:________________"
        LINHA=LINHA+3        
         @ LINHA,02 SAY "OBS :_____________________________________________________________________"
     LINHA=LINHA+2
     @ linha,01 say "____________________________________________________________________________"
        LINHA=LINHA+3
      @ linha,01 say "==============================================================================="                                  
        LINHA=LINHA+2
        @ LINHA,02 SAY "TECNICO RESP.:______________________________"
        LINHA=LINHA+2                                
        @ LINHA,02 SAY "APROVADO EM: ___/___/_______"
        LINHA=LINHA+1                                
      @ linha,01 say "==============================================================================="
        LINHA=LINHA+2                                
       @ LINHA,01 SAY " " 
